...
def create_app():
    ...
    app.logger.info('Prometheus registry and metrics ready')
    ...
    from functions.management.pipeline import check_workers,system_monitoring, server_monitoring, data_pipeline, model_pipeline, update_pipeline, aggregation_pipeline
